...
PIN(-35,165,0.060,0.840)Phase0
PIN(-35,155,0.060,0.840)Phase1
PIN(-35,145,0.060,0.420)Phase2
PIN(-35,135,0.060,0.420)Phase3
LIG(-75,145,-70,145)
LIG(-75,135,-70,135)
LIG(-40,165,-35,165)
LIG(-40,155,-35,155)
...
BB(5,125,45,245)
TITLE 15 117  #VsmMicroInstruction
MODEL 6000
PROP                                                                                                                                    
REC(10,130,30,110,r)
VIS 5
...
PIN(45,155,0.060,1.050)LoadOut
PIN(45,195,0.060,1.260)EnableInstr
PIN(45,165,0.060,1.050)LoadInst
PIN(45,225,0.060,1.260)EnableA
PIN(45,205,0.060,1.260)EnableIn
PIN(45,185,0.060,1.050)LoadA
PIN(45,135,0.060,1.050)ReadMem
PIN(45,145,0.060,1.050)ProgCount
PIN(45,215,0.060,1.260)EnableAlu
PIN(45,175,0.060,0.910)LoadAlu
PIN(45,235,0.060,1.330)AddSub
LIG(5,135,10,135)
LIG(5,155,10,155)
LIG(5,165,10,165)
LIG(5,205,10,205)
...
VLG  LoadOut,EnableInstr,LoadInst,EnableA,EnableIn,LoadA,ReadMem,ProgCount,
VLG  EnableAlu,LoadAlu,AddSub);
VLG  input Phase3,Phase1,Phase0,InstrIn0,InstrIn1,InstrIn2,InstrIn3,Phase2;
VLG  output LoadOut,EnableInstr,LoadInst,EnableA,EnableIn,LoadA,ReadMem,ProgCount;
VLG  output EnableAlu,LoadAlu,AddSub;
VLG  wire w2,w4,w6,w7,w15,w18,w20,w21;
VLG  wire w24,w25,w28,w29,w33,w34,w35,w36;
VLG  wire w37,w38,w39;
VLG  and #(86) and2_1(w4,w2,Phase2);
VLG  and #(86) and2_2(w6,w2,Phase3);
VLG  nmos #(87) nmos_3(AddSub,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_4(ProgCount,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_5(EnableIn,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_6(LoadOut,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_7(LoadOut,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_8(AddSub,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_9(ReadMem,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_10(EnableInstr,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_11(LoadOut,vdd,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_12(LoadInst,vss,w4); // 1.0u 0.12u
VLG  not #(38) inv_13(w18,InstrIn3);
VLG  nmos #(87) nmos_14(EnableIn,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_15(LoadInst,vss,w6); // 1.0u 0.12u
VLG  and #(23) and4_16(w2,w20,w21,InstrIn2,w18);
VLG  nmos #(87) nmos_17(EnableInstr,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_18(AddSub,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_19(ReadMem,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_20(LoadAlu,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_21(ProgCount,vdd,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_22(LoadInst,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_23(LoadInst,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_24(ProgCount,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_25(ReadMem,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_26(ProgCount,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_27(EnableIn,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_28(EnableInstr,vdd,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_29(LoadInst,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_30(LoadInst,vdd,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_31(ProgCount,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_32(EnableInstr,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_33(EnableIn,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_34(ReadMem,vdd,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_35(EnableIn,vss,w24); // 1.0u 0.12u
VLG  and #(23) and4_36(w29,InstrIn0,InstrIn1,w28,w18);
VLG  and #(86) and2_37(w24,w29,Phase2);
VLG  nmos #(87) nmos_38(EnableAlu,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_39(EnableIn,vdd,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_40(LoadA,vdd,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_41(LoadA,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_42(EnableA,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_43(EnableA,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_44(LoadA,vss,Phase0); // 1.0u 0.12u
VLG  and #(86) and2_45(w25,w29,Phase3);
VLG  nmos #(87) nmos_46(LoadAlu,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_47(EnableAlu,vss,Phase0); // 1.0u 0.12u
VLG  nmos #(87) nmos_48(EnableAlu,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_49(LoadAlu,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_50(EnableA,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_51(EnableA,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_52(LoadA,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_53(LoadA,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_54(LoadAlu,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_55(EnableA,vdd,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_56(EnableAlu,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_57(EnableAlu,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_58(LoadAlu,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_59(AddSub,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_60(AddSub,vss,Phase1); // 1.0u 0.12u
VLG  nmos #(87) nmos_61(LoadOut,vss,Phase1); // 1.0u 0.12u
VLG  and #(23) and4_62(w33,w20,w21,w28,w18);
VLG  nmos #(87) nmos_63(LoadOut,vss,w4); // 1.0u 0.12u
VLG  nmos #(87) nmos_64(LoadOut,vss,w6); // 1.0u 0.12u
VLG  not #(24) inv_65(w20,InstrIn0);
VLG  not #(31) inv_66(w28,InstrIn2);
VLG  not #(24) inv_67(w21,InstrIn1);
VLG  and #(86) and2_68(w34,w33,Phase3);
VLG  and #(86) and2_69(w35,w33,Phase2);
VLG  nmos #(87) nmos_70(ProgCount,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_71(EnableA,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_72(ProgCount,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_73(ReadMem,vdd,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_74(EnableInstr,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_75(LoadInst,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_76(LoadInst,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_77(EnableInstr,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_78(EnableAlu,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_79(ReadMem,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_80(LoadA,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_81(EnableInstr,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_82(ProgCount,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_83(EnableIn,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_84(LoadAlu,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_85(LoadA,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_86(EnableIn,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_87(LoadA,vdd,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_88(EnableA,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_89(EnableA,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_90(LoadA,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_91(LoadAlu,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_92(EnableAlu,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_93(EnableAlu,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_94(LoadAlu,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_95(AddSub,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_96(LoadOut,vss,w35); // 1.0u 0.12u
VLG  nmos #(87) nmos_97(LoadOut,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_98(AddSub,vss,w34); // 1.0u 0.12u
VLG  nmos #(87) nmos_99(AddSub,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_100(LoadOut,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_101(LoadOut,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_102(AddSub,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_103(LoadAlu,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_104(EnableAlu,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_105(EnableAlu,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_106(LoadAlu,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_107(LoadA,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_108(EnableA,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_109(EnableA,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_110(LoadA,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_111(EnableIn,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_112(EnableA,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_113(EnableA,vdd,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_114(ReadMem,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_115(EnableIn,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_116(ProgCount,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_117(LoadAlu,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_118(ReadMem,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_119(LoadA,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_120(EnableInstr,vss,w36); // 1.0u 0.12u
VLG  and #(23) and4_121(w38,InstrIn0,w21,w28,w18);
VLG  nmos #(87) nmos_122(LoadInst,vss,w36); // 1.0u 0.12u
VLG  nmos #(87) nmos_123(LoadInst,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_124(EnableInstr,vss,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_125(ReadMem,vdd,w37); // 1.0u 0.12u
VLG  nmos #(87) nmos_126(EnableAlu,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_127(ProgCount,vss,w37); // 1.0u 0.12u
VLG  and #(86) and2_128(w36,w38,Phase3);
VLG  and #(86) and2_129(w37,w38,Phase2);
VLG  and #(86) and2_130(w15,w39,Phase2);
VLG  and #(86) and2_131(w7,w39,Phase3);
VLG  nmos #(87) nmos_132(EnableAlu,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_133(ProgCount,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_134(LoadAlu,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_135(ReadMem,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_136(ReadMem,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_137(EnableInstr,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_138(LoadInst,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_139(LoadInst,vss,w7); // 1.0u 0.12u
VLG  and #(23) and4_140(w39,w20,InstrIn1,w28,w18);
VLG  nmos #(87) nmos_141(EnableInstr,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_142(EnableIn,vss,w15); // 1.0u 0.12u
VLG  nmos #(87) nmos_143(ReadMem,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_144(AddSub,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_145(ProgCount,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_146(EnableIn,vss,w7); // 1.0u 0.12u
VLG  nmos #(87) nmos_147(EnableInstr,vss,w24); // 1.0u 0.12u
VLG  nmos #(87) nmos_148(AddSub,vss,w6); // 1.0u 0.12u
VLG  nmos #(87) nmos_149(AddSub,vss,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_150(LoadOut,vdd,w25); // 1.0u 0.12u
VLG  nmos #(87) nmos_151(LoadOut,vdd,w24); // 1.0u 0.12u
VLG endmodule
FSYM
SYM  #Arrow
BB(-80,102,-70,108)
...
PIN(100,350,0.060,0.280)ToInstr0
PIN(100,340,0.060,0.280)ToInstr1
PIN(100,330,0.060,0.210)ToInstr2
...
TITLE -18 310  #Mem8x8
MODEL 865
PROP   01000000 00110000 00000000 00000000 00000000 00000000 00000000 00000000                                                                                                                          
REC(-18,320,20,40,r)
VIS 3
...
FFIG D:\Documents and Settings\sicard\Mes documents\Dsch3\vsm\Vsm-Microprocessor-InOut.sch
